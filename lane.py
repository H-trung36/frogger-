...
class Lane:
  ...
  def setupObstacle(self):
    ...
    if self.lane_type == "street":
      ...
      image_directory = f"assets/{self.lane_type}/{self.direction}/car{car}.png"
      ...
      if self.direction == "left":
        ...
        left = f"assets/{self.lane_type}/{self.direction}/left.png"
        middle = f"assets/{self.lane_type}/{self.direction}/middle.png"
        right = f"assets/{self.lane_type}/{self.direction}/right.png"
